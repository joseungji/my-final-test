...
st.image("banner/banner.png", width=800)
...
with tab3:
    ...
    for quarter in QUARTERS:
        chart_data.append({"분기": quarter, "평균": float(quarter_average(branches, quarter))})
...
with tab4:
    ...
    dist_data = [{"등급": g, "지점수": dist.get(g, 0)} for g in ["A", "B", "C", "D", "F"]]
